...
from .CustomPayment import CustomPaymentView, CreateCustomCheckoutSessionView, CustomCheckoutSuccess
...
urlpatterns = [
    ...
    path('custom_subscriber_success', CustomCheckoutSuccess.as_view(), name='success'),
    ...
    path('create_custom_checkout_session', CreateCustomCheckoutSessionView.as_view(), name='create-custom-checkout-session')
]