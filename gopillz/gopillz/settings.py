"""
Django settings for gopillz project.
...
SECRET_KEY = 'django-insecure-i)-(#=ve1e0j)ukhevioerv6k6=(ceyxt#_f4=qcw@qshe5%d3'
...
WSGI_APPLICATION = 'gopillz.wsgi.application'
...
SMS_MESSAGE = os.getenv('SMS_MESSAGE')
